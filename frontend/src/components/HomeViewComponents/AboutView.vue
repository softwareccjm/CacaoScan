      ...
      <div class="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
        <div class="mb-8 lg:mb-0">
          ...
          <div class="prose text-gray-600 space-y-4">
            ...
            <p>Desarrollado en el marco del programa de formación del SENA, este proyecto combina tecnologías de
              vanguardia con un profundo entendimiento de las necesidades de la industria cacaotera colombiana.</p>
          </div>
        </div>
        <div class="bg-gray-100 rounded-xl p-6 shadow-inner">
          <img src="@/assets/Cacao/GranosCacao.jpg" alt="Granos de cacao" class="rounded-lg shadow-md w-full h-auto">
        </div>
      </div>
    </div>
  </section>
