    ...
    <div class="min-h-screen bg-gray-50 flex pb-8">
          ...
          <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600">Estadísticas y análisis de datos</p>
              </div>
            </div>
          </div>
        </header>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex justify-between items-center">
          <div>
            <h2 class="text-xl font-semibold text-gray-800">Reportes y Estadísticas</h2>
            <p class="text-sm text-gray-500">Visualiza y exporta informes detallados sobre la producción de cacao</p>
          </div>
          <div class="flex items-center space-x-3">
            <div class="relative">
              <select class="pl-9 pr-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 appearance-none">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
            <div class="p-5">
              <div class="flex items-center">
                ...
                <div class="ml-5">
                  <dl>
                    <dt class="text-sm font-medium text-gray-500 truncate">Producción Total</dt>
                    <dd class="mt-1">
                      <div class="text-2xl font-semibold text-gray-900">12,450 kg</div>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
            <div class="p-5">
              <div class="flex items-center">
                ...
                <div class="ml-5">
                  <dl>
                    <dt class="text-sm font-medium text-gray-500 truncate">Calidad Promedio</dt>
                    <dd class="mt-1">
                      <div class="text-2xl font-semibold text-gray-900">78%</div>
                      <div class="text-sm text-purple-600 flex items-center mt-1">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path>
                        </svg>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
            <div class="p-5">
              <div class="flex items-center">
                ...
                <div class="ml-5">
                  <dl>
                    <dt class="text-sm font-medium text-gray-500 truncate">Agricultores Activos</dt>
                    <dd class="mt-1">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <!-- Las gráficas han sido removidas -->
        </div>
  
        <!-- Reportes disponibles -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300 mb-6">
          <div class="p-5 border-b border-gray-100">
            <div class="flex justify-between items-center">
              <div>
                <h3 class="text-lg font-semibold text-gray-800">Reportes Disponibles</h3>
                <p class="text-sm text-gray-500">Selecciona un reporte para visualizar o exportar</p>
              </div>
              <div>
                <button class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-md text-sm font-medium flex items-center transition-colors duration-150">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nombre del Reporte</th>
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      ...
                      <div class="ml-4">
                        <div class="text-sm font-medium text-gray-900">Producción Mensual 2023</div>
                        <div class="text-sm text-gray-500">Reporte detallado de producción por mes</div>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      ...
                      <div class="ml-4">
                        <div class="text-sm font-medium text-gray-900">Calidad por Región</div>
                        <div class="text-sm text-gray-500">Análisis comparativo de calidad por región</div>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p class="text-sm text-gray-700">
                  Mostrando <span class="font-medium">1</span> a <span class="font-medium">2</span> de <span class="font-medium">12</span> resultados
                </p>
              </div>
              <div>
