...
if running_jobs.exists():
    print("\n⚠️  Tienes entrenamientos corriendo.")
    print("\n📌 OPCIONES:")
    print("\n1️⃣  CANCELAR el entrenamiento actual y empezar uno nuevo")
    print("   ✓ Usará las nuevas mejoras (150 épocas, validación de crops, etc.)")
    print("   ✓ Mejor confianza (≥80%)")
    print("   ✓ Validación automática de crops")
    print("\n2️⃣  DEJAR que termine el actual")
    print("   ✗ No usará las mejoras nuevas")
    print("   ✗ Confianza baja (29.9%)")
