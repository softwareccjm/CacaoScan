...
class Command(BaseCommand):
    ...
    def _show_api_info(self):
        ...
        self.stdout.write("  • API Base: http://localhost:8000/api/v1/")
        
        self.stdout.write("\nEndpoints principales:")
        self.stdout.write("  • POST /api/v1/scan/measure/ - Medir grano de cacao")
        self.stdout.write("  • GET /api/v1/models/status/ - Estado de modelos")
        self.stdout.write("  • POST /api/v1/models/load/ - Cargar modelos")
        self.stdout.write("  • GET /api/v1/dataset/validation/ - Validar dataset")
        ...
        self.stdout.write("\nPara probar la API:")
        self.stdout.write("  • python example_api_usage.py")
        self.stdout.write("  • curl -X POST -F 'image=@test.jpg' http://localhost:8000/api/v1/scan/measure/")
