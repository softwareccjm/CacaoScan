...
class Command(BaseCommand):
    ...
    def _confirm_training(self, options):
        ...
        # En Docker, auto-confirmar si no hay input disponible
        # En producción, esto debería ser True por defecto
        return True  # Auto-confirmar para procesos no interactivos
