...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=3,
            help='pocas de warmup (default: 3)'
        )
        parser.add_argument(
            '--save-period',
            type=int,
    ...
    def _validate_arguments(self, options):
        ...
        if options['epochs'] < 1:
            raise CommandError(
                f'pocas debe ser al menos 1, actual: {options["epochs"]}'
            )
    ...
    def _display_configuration(self, options):
        ...
        self.stdout.write('\n' + '='*60)
        self.stdout.write(self.style.SUCCESS('CONFIGURACI"N DE ENTRENAMIENTO YOLO'))
        self.stdout.write('='*60)
        
        config_items = [
            ('Dataset Size', options['dataset_size']),
            ('Modelo Base', options['model_name']),
            ('pocas', options['epochs']),
    ...
    def _confirm_training(self, options):
        ...
        self.stdout.write('\n' + self.style.WARNING('[WARN]  ADVERTENCIA:'))
